...
publishDate: '2024-09-28 16:00:00'
...
Recently I was sitting in a waiting room with an expected wait time of 8 hours. And while I was scrolling through social media on my phone, I suddenly had an idea for a project but my laptop was nowhere near to try it out. Now I could have done what I (and probably you) have done so often before when an idea strikes while I'm out and about. I can open my notes app and write it down just for it to be lost and likely never be seen again.

But instead I decided to try out the new [Replit Agent](https://replit.com/blog/replit-agent) that had launched on mobile just a few days earlier and see what it can do. I gave it a prompt, it devised a plan and then started executing it by installing dependencies, creating checkpoints, asking me to verify different steps of the plan and ultimately offering me to deploy it. 

While it was far from perfect it was also a magical experience that made me think that thanks to AI we might finally be closer than ever to a world where anyone can code from anywhere, whether it's at home on your laptop or in a waiting room on your phone.

In this blog post we'll go through the history of development on mobile, how we got here and how I believe we might finally get there with the help of AI.
...
At the same time CDEs have increasingly begun to include AI-powered features into their tooling by leveraging cloud-based AI models since running AI directly locally in browsers is still mostly infeasible. 
...
With LLMs' continous advancements in their coding abilities, syntax will no longer be a barrier to writing code and enable to [focus both engineers and non-engineers to focus on semantics](https://www.alessiofanelli.com/posts/syntax-to-semantics) and the problems at hand instead.
...
Some promosing early versions of programming specific AI Agents are [Cognition's Devin](https://www.cognition.ai/blog/introducing-devin), [GitHub Copilot Workspace](https://github.blog/news-insights/product-news/github-copilot-workspace/) or [Replit Agent](https://blog.replit.com/introducing-replit-agent). 
...
When [GitHub Copilot Workspace](https://github.blog/news-insights/product-news/github-copilot-workspace/) was announced in April 2024 they immediately announced support for their GitHub mobile app along side it.
...
- provide a seamless experience across different platforms
- integrate with the vast ecosystem of tools that developers tend to already
- pass the rigorous security and privacy standards of the companies whose developers who will be using them
- continue to iterate on the user experience that while better, is still far from perfect
- be accessible to developers both at work and at home because developers try to bring their personal tools to work

Even with its current limitations, I'd encourage you to check out some of the tools mentioned (or others), since we are getting faster than ever towards a world where we can have an idea on the go that we can immediately begin turning into reality, no matter where we are using just text or voice and our phone.
