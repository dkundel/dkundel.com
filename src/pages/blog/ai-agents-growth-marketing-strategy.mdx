...
![A diagram of how an AI agent works](ai-agents-growth-marketing-strategy/agent-diagram.webp)
...
![MultiOn booking a table on OpenTable.](ai-agents-growth-marketing-strategy/multi-on.webp)
...
![AI enabled personalized solutions, so we could see VIP treatment at scale.](ai-agents-growth-marketing-strategy/resolution-conversation.webp)
