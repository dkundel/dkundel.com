...
const TalkContainer = styled('section', 'talk-entry bg-white dark:bg-slate-800 shadow-md rounded-lg overflow-hidden mb-6 p-3 hover:shadow-lg focus:shadow-lg focus-within:shadow-lg max-w-[800px] hover:scale-[1.02] focus:scale-[1.02] focus-within:scale-[1.02] transition-transform');
const TalkEvent = styled('h4', 'text-md dark:text-pink-400 font-semibold mx-0 mb-0');
const TalkTopic = styled('p', 'text-sm dark:text-gray-300 mx-0 my-2 pb-2 border-0 border-b-2 border-solid border-secondaryGreen-500');
